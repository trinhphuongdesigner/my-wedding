      ...
      <footer className="bg-white py-12 text-center reveal border-t border-gray-200">
        <div className="max-w-2xl mx-auto px-4">
          ...
          <div className="flex justify-center space-x-6 mb-6">
            <a href="https://www.facebook.com/trinhphuong.dev/" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-rose-500 transition-all duration-300 hover:scale-110">
            ...
            <a href="https://www.instagram.com/_22august96_/" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-rose-500 transition-all duration-300 hover:scale-110">
              <svg className="w-6 h-6 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
